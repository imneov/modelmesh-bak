...
type WizeProxyConfigBuilder struct {
...
func NewWizeProxyConfigBuilder() *WizeProxyConfigBuilder {
	return &WizeProxyConfigBuilder{
...
func (b *WizeProxyConfigBuilder) SetAdminConfigBuilder(builder *AdminConfigBuilder) *WizeProxyConfigBuilder {
	b.AdminConfigBuilder = builder
	return b
}

func (b *WizeProxyConfigBuilder) SetMySQLConfigBuilder(builder *MySQLConfigBuilder) *WizeProxyConfigBuilder {
	b.MySQLConfigBuilder = builder
	return b
}

func (b *WizeProxyConfigBuilder) SetProxyConfigBuilder(builder *ProxyConfigBuilder) *WizeProxyConfigBuilder {
	b.ProxyConfigBuilder = builder
	return b
}

func (b *WizeProxyConfigBuilder) SetNodeGroupConfigBuilder(builder *NodeGroupConfigBuilder) *WizeProxyConfigBuilder {
	b.NodeGroupConfigBuilder = builder
	return b
}

func (b *WizeProxyConfigBuilder) Build() *WizeProxyConfig {
	config := &WizeProxyConfig{}
...
type WizeDaemonConfigBuilder struct {
	AppBuilders []*AppBuilder
}

func NewWizeDaemonConfigBuilder() *WizeDaemonConfigBuilder {
	return &WizeDaemonConfigBuilder{}
}

func (b *WizeDaemonConfigBuilder) SetAppBuilders(bs []*AppBuilder) *WizeDaemonConfigBuilder {
	b.AppBuilders = bs
	return b
}

func (b *WizeDaemonConfigBuilder) Build() *WizeDaemonConfig {
	config := &WizeDaemonConfig{
		Apps: []App{},
	}
