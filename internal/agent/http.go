...
func proxyConfigBuild(vdb *v1alpha1.VirtualDatabase, tslist *v1alpha1.TrafficStrategyList, dslist *v1alpha1.DataShardList, dbeplist *v1alpha1.DatabaseEndpointList) (*WizeProxyConfig, error) {
	builder := NewWizeProxyConfigBuilder()
...
func daemonConfigBuild(vdblist *v1alpha1.VirtualDatabaseList, tslist *v1alpha1.TrafficStrategyList, qclist *v1alpha1.QoSClaimList, dbeplist *v1alpha1.DatabaseEndpointList) (interface{}, error) {
	...
	daemonConfig := NewWizeDaemonConfigBuilder().SetAppBuilders(appbuilders).Build()
