...
func Test_build(t *testing.T) {
	...
	assertWizeProxyConfig(t, expected, actual, "pisaProxyConfig should be equal")
}

func assertWizeProxyConfig(t *testing.T, exp, act *WizeProxyConfig, msg ...interface{}) bool {
